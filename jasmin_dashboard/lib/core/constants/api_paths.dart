class ApiPaths {
  ...
  static String orderDetail(String orderNumber) =>
      '/api/admin/orders/${Uri.encodeComponent(orderNumber)}';
  ...
  static String gameDetail(String id) =>
      '/api/admin/games/${Uri.encodeComponent(id)}';
  static const String gameReorder = '/api/admin/games/reorder';
  static const String banners = '/api/admin/banners';
  static String bannerDetail(String id) =>
      '/api/admin/banners/${Uri.encodeComponent(id)}';
  static const String settings = '/api/admin/settings';
  static const String faqs = '/api/admin/faqs';
  static String faqDetail(String id) =>
      '/api/admin/faqs/${Uri.encodeComponent(id)}';
  static const String customers = '/api/admin/customers';
  static String customerDetail(String key) =>
      '/api/admin/customers/${Uri.encodeComponent(key)}';
  static const String promoCodes = '/api/admin/promo-codes';
  static String promoCodeDetail(String id) =>
      '/api/admin/promo-codes/${Uri.encodeComponent(id)}';
  ...
  static String notificationDetail(String id) =>
      '/api/admin/notifications/${Uri.encodeComponent(id)}';
}
