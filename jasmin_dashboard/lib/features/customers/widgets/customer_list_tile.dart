  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: InkWell(
        ...
        onTap: () =>
            context.go('/customers/${Uri.encodeComponent(customer.key)}'),
        child: Padding(
                ...
                child: Column(
                  ...
                  Wrap(spacing: 8, runSpacing: 6, children: [
                    ...
                    _MiniInfo(
                        ...
                        label: '${customer.paidOrders} paid'),
                    _MiniInfo(
                        icon: Icons.attach_money_rounded,
                        label: Formatters.moneyUsd(customer.lifetimeUsd)),
                    _MiniInfo(
                        icon: Icons.sports_esports_rounded,
                        label: '${customer.uidCount} UID'),
                  ]),
                ])),
