            ...
            children: [
                    ...
                    Wrap(
                      ...
                      children: [
                        _MiniInfo(
                            ...
                            label: game.currencyName.isEmpty
                                ? 'Currency'
                                : game.currencyName),
                        _MiniInfo(
                        ...
                        _MiniInfo(
                            ...
                            label: 'Order ${game.sortOrder}'),
                        _MiniInfo(
                            icon: Icons.inventory_2_rounded,
                            label: '${game.productsCount} products'),
                        _MiniInfo(
                            icon: Icons.receipt_long_rounded,
                            label: '${game.ordersCount} orders'),
                        if (game.updatedAt != null)
                          _MiniInfo(
                              icon: Icons.update_rounded,
                              label: Formatters.dateTimeOrDash(game.updatedAt)),
                      ],
                    ),
                  ],
                ),
              ...
              if (isBusy)
                ...
                PopupMenuButton<String>(
                  ...
                  onSelected: (value) {
                    if (value == 'edit') {
                      context.go('/games/${Uri.encodeComponent(game.id)}');
                    }
                    if (value == 'toggle') {
                      onToggleActive();
                    }
...
class _GameAvatar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final color =
        game.active ? Theme.of(context).colorScheme.primary : Colors.black45;
