...
final promoCodesApiProvider =
    Provider<PromoCodesApi>((ref) => PromoCodesApi(ref.watch(dioProvider)));
...
class PromoCodesApi {
  ...
  Future<PromoCodeModel> fetchPromoCode(String id) async {
    final response =
        await _dio.get<Map<String, dynamic>>(ApiPaths.promoCodeDetail(id));
  ...
  Future<PromoCodeModel> createPromoCode(PromoCodePayload payload) async {
    final response = await _dio.post<Map<String, dynamic>>(ApiPaths.promoCodes,
        data: payload.toJson());
    return PromoCodeModel.fromJson(response.data ?? const <String, dynamic>{});
  }
  ...
  Future<bool> deletePromoCode(String id) async {
    final response =
        await _dio.delete<Map<String, dynamic>>(ApiPaths.promoCodeDetail(id));
